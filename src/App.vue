...
<template>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item">
                            <router-link class="nav-link fs-5 d-flex align-items-center gap-3"
                                v-bind:to="`/user/${user_id}`" @click="updateCurrentUserID"> 
                                <svg
                                ...
                                </svg>Мой канал</router-link>
                        </li>
                        <li class="nav-item">
                            <router-link class="nav-link fs-5 d-flex align-items-center gap-3" to="/history"> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" fill="currentColor"
                                ...
                                </svg>История просмотров</router-link>
                        </li>
                        <li class="nav-item ">
                        ...
                        <li class="nav-item ">
                            <router-link class="nav-link fs-5 d-flex align-items-center gap-3" to="/settings"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" fill="currentColor" class="bi bi-gear"
                                    viewBox="0 0 16 16">
                                    <path
                        ...
                        <li class="nav-item">
                            <router-link class="nav-link fs-5 d-flex align-items-center gap-3" to="/login"
                                @click.native="Exit">
    ...
    <div class="container-fluid gradient-custom"><router-view></router-view></div>
</template>
